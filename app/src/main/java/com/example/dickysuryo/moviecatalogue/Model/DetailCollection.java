...
public class DetailCollection implements Parcelable
{
    ...
    public final static Parcelable.Creator<DetailCollection> CREATOR = new Creator<DetailCollection>() {


        @SuppressWarnings({
                "unchecked"
        })
        public DetailCollection createFromParcel(Parcel in) {
            return new DetailCollection(in);
        }
    ...
    protected DetailCollection(Parcel in) {
        ...
        in.readList(this.genres, (com.example.dickysuryo.moviecatalogue.Model.Genre.class.getClassLoader()));
        ...
        in.readList(this.productionCompanies, (com.example.dickysuryo.moviecatalogue.Model.ProductionCompany.class.getClassLoader()));
        in.readList(this.productionCountries, (com.example.dickysuryo.moviecatalogue.Model.ProductionCountry.class.getClassLoader()));
        this.releaseDate = ((String) in.readValue((String.class.getClassLoader())));
        this.revenue = ((Integer) in.readValue((Integer.class.getClassLoader())));
        this.runtime = ((Integer) in.readValue((Integer.class.getClassLoader())));
        in.readList(this.spokenLanguages, (com.example.dickysuryo.moviecatalogue.Model.SpokenLanguage.class.getClassLoader()));
